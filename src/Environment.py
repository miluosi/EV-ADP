...
class ChargingIntegratedEnvironment(Environment):
    ...
    def __init__(self, num_vehicles=5, num_stations=3, grid_size=30, use_intense_requests=True, assignmentgurobi=True, random_seed=None):  # Increased grid size
    ...
    def _calculate_rejection_probability(self, vehicle_id, request):
        ...
        distance_factor = 0.1  # Exponential growth factor
    ...
    def _generate_intense_requests(self):
        ...
        if random.random() < self.request_generation_rate:
            ...
            selected_hotspot_idx_reward = [50, 10, 20, 20, 50]  # Reward weights for each hotspot
            for _ in range(num_requests):
                self.request_counter += 1
    ...
    def _assign_request_to_vehicle(self, vehicle_id, request_id):
        ...
        if request_id in self.active_requests and vehicle_id in self.vehicles:
            ...
            if vehicle['assigned_request'] is None or vehicle['passenger_onboard'] is None:
                ...
                #print("assign_request_to_vehicle: Vehicle {} ACCEPTED request {} at step {}".format(vehicle_id, request_id, self.current_time))
    ...
    def _dropoff_passenger(self, vehicle_id):
        ...
        if vehicle['passenger_onboard'] is not None:
            ...
            if vehicle_coords == dropoff_coords:
                ...
                self.whole_req += completed_request.final_value
                # Calculate earnings
    ...
    def _execute_action(self, vehicle_id, action):
        ...
        if vehicle.get('is_stationary', False):
            ...
            self.storeactions[vehicle_id].dur_reward += - avg_request_value*0.05
            return - avg_request_value*0.05, - avg_request_value*0.05
    ...
    def _execute_movement_towards_idle(self, vehicle_id, target_coords):
        ...
        return (self.movingpenalty  +  np.abs(np.random.normal(0, 0.05)))*distance   - avg_request_value*0.05
