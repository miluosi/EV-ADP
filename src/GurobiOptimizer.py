...
class GurobiOptimizer:
                    ...
                    if adp_weight <= 0:
                        ...
                        if hasattr(self.env, 'evaluate_service_option'):
                            try:
                                ...
                                option_q = 0.0
                        objective_terms += option_q*(1 - rejection_prob) * adp_weight * request_decision[i, j]
    ...
    def _heuristic_assignment_with_reject(self, vehicle_ids, available_requests, charging_stations=None, battery_threshold=0.5):
